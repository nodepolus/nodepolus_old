...
export class Player extends AsyncEventEmitter {
	...
	get color(): PlayerColor { return this.int_color }
	private int_skin: PlayerSkin;
	get skin(): PlayerSkin { return this.int_skin }
	private int_hat: PlayerHat;
	get hat(): PlayerHat { return this.int_hat }
	private int_pet: PlayerPet;
	get pet(): PlayerPet { return this.int_pet }
	private int_tasks: Task[];
	get tasks(): Task[] { return this.int_tasks }
	private int_isAlive: boolean;
	get isAlive(): boolean { return this.int_isAlive }
